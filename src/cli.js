...
//   Usage
//     $ steez-generate [name]
//     $ steez-scaffold [{{component}} path]

//   Examples
//     $ steez-generate SiteHeader
//     $ steez-scaffold src/components/Button.js
// `)
const steezGenerateComponent = async name => {
...
if (cli.input.length) {
  steezGenerateComponent(cli.input[0])
} else {
  scan(cli.flags.root).then(steezGenerateComponent)
}
